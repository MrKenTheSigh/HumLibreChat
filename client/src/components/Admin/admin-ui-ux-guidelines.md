...
This document captures admin console UI rules. Use these rules across `client/src/components/Admin/**/*`
unless a page has a clear operational reason to diverge.
