...
This directory holds planning notes that are not all at the same maturity level.

## Structure

- `admin/`
  Phase-based implementation plans for the admin backoffice work that is already sequenced.
- `backlog/`
